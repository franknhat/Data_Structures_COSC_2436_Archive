#modified the hw2 test2.sh so I can run the 9 test cases since I couldnt figure out how to change 
#Compile the code
...
for casenum in `seq 1 1 9`; do
	./${cmd} "input=input${hwnumber}${casenum}.txt;command=command${hwnumber}${casenum}.txt;output=output${hwnumber}${casenum}.txt"
